# app.py - Professional TTS Generator with Browser Cache Fix
import asyncio
import json
import os
import random
...
<body>
    ...
    <script>
        ...
        // Show output with CACHE BUSTER - Key function to prevent browser cache
...
if __name__ == "__main__":
    ...
    print("Browser Cache Fix Features:")
    print("1. Unique filenames with UUID and timestamp")
    print("2. Cache buster URLs (?t=timestamp_random)")
    print("3. No-cache headers for downloads")
    print("4. Auto cleanup of old files")
    print("=" * 60)
