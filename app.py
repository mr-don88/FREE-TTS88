    ...
    def load_settings(self):
        if os.path.exists(TTSConfig.SETTINGS_FILE):
            ...
            self.settings = {
                ...
                "multi_voice": {
                    "char1": {"voice": "vi-VN-HoaiMyNeural", "rate": 0, "pitch": 0, "volume": 100},
                    "char2": {"voice": "vi-VN-NamMinhNeural", "rate": -10, "pitch": 0, "volume": 100},
                    "pause": 500,
                    "repeat": 1
                },
                "qa_voice": {
...
<body>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', async () => {
            // Load Vietnamese voices by default
            await loadVoices('Tiếng Việt', document.getElementById('singleVoice'));
            ...
            for (const select of multiVoiceSelects) {
                await loadVoices('Tiếng Việt', select);
            }
            
            // Load voices for Q&A tab
